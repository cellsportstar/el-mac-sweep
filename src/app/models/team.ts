export interface Team {
  ...
  export const TEAMS = {
    ...
    EGYPT: { id: 'EGY', name: 'Egypt', isStillIn: false },
    ENGLAND: { id: 'ENG', name: 'England', isStillIn: false },
    FRANCE: { id: 'FRA', name: 'France', isStillIn: false },
    GERMANY: { id: 'GER', name: 'Germany', isStillIn: false },
    GHANA: { id: 'GHA', name: 'Ghana', isStillIn: false },
    ...
    SWITZERLAND: { id: 'SUI', name: 'Switzerland', isStillIn: false },
    ...
    USA: { id: 'USA', name: 'USA', isStillIn: false },
